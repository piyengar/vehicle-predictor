...
from experiments.vtype.datamodule import TypeDataModule
from experiments.vtype.dataset.vtype import Type
...
class TypeExperiment(BaseExperiment):
    ...
    def get_target_names(self) -> List[str]:
        return self.class_names or list(map(str, list(Type)))
