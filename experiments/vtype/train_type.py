...
from experiments.vtype.experiment import TypeExperiment
...
def run_experiment(args):
    ...
    exp = TypeExperiment(class_names=allowed_brand_list, **vars(args))
...
if __name__=="__main__":
    ...
    parser=argparse.ArgumentParser(
        description="Run experiments on vehicle type based models",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    parser = TypeExperiment.add_parser_args(parser)
